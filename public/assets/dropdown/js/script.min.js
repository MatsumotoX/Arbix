...
$(window).scroll(function () {
    ...
    if (scroll > 50) {
       $(".cid-qTkzRZLJNu .navbar").css('background-color', 'white');
       $(".text-white-nav").css('cssText', 'color: #333333 !important;');
       $(".navbar-logo>a>img").attr("src","assets/images/eecl-logo-1-color-02.png");
       $(".hamburger>span").css('background-color', '#333333');

       
   } else {
       $(".cid-qTkzRZLJNu .navbar").css('background-color', 'transparent');
       $(".text-white-nav").css('cssText', 'color: #ffffff !important;');
       $(".navbar-logo>a>img").attr("src","assets/images/eecl-logo-1-274x183.png");
